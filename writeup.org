...
This work introduces a new proxy measure of policy alignment between states:
website blocking. This measure speaks to the information flow in the digital
layer of international politics, a new element to international trade and
cooperation, and one which existing metrics fail to capture. In addition, our
