...
However, in part due to advances in telecommunications technologies including
the Internet, international trade in services grew. Services, defined as
"products of economic activity that you can’t drop on your foot"
cite:economist-services, led to a new set of agreements, includng the General
Agreement on Trade in Services (GATS) agreement in the World Trade Organization.
These agreements aimed to cope with the international trade in information.
Despite the primacy of this topic in world trade, existing metrics struggle to
capture specific barriers to international data flows, making their effect on
trade (and trade's effect on these barriers) difficult to quantify.
