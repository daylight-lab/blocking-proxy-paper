...
perspective. Debates over the row of information flows in international trade
were a primary subject of the Uruguay round of the General Agreement on Tariffs
and Trade (GATT) beginning 1986, negotiations that ultimately produced the World
Trade Organization (WTO) cite:gallagher2005first. Despite the primacy of these
debates, existing metrics struggle to capture specific barriers to international
