...
(GATT) dealt only with goods. However, in part due to advances in
telecommunications technologies including the Internet, international trade in
services grew. Services, defined as "products of economic activity that you
can’t drop on your foot," cite:economist-services led ultimately to the GATS
agreement, which helped to deal with international trade in information
cite:gallagher2005first. Despite the primacy of this topic in international
trade, existing metrics struggle to capture specific barriers to international
data flows, making their effect on trade (and trade's effect on these barriers)
